    ...
    <section id="hero" className="relative overflow-hidden py-24">
      ...
      <Container className="relative z-10 pt-28 flex max-w-5xl flex-col items-center text-center">
        <h1 className="font-space-grotesk-heading text-5xl font-bold tracking-tight md:text-6xl text-balance">
          Commits into <span className="text-brand">changelog & release in seconds.</span>
        </h1>

        <p className="mt-4 max-w-2xl text-sm text-balance md:text-base leading-6 text-muted-foreground">
          Dyit analyzes your commits, pull requests, and changes to automatically generate beautiful
          changelogs and release notes—ready to publish in seconds.
        </p>

        <div className="mt-8 flex flex-col gap-2 sm:flex-row">
          <Button
            onClick={() => router.push('/join-waitlist')}
            className={'font-space-grotesk-heading cursor-crosshair'}
          >
            Join The Waitlist
            <HugeiconsIcon
              icon={JoinBevelIcon}
        ...
        <p className="max-w-xs text-xs text-muted-foreground mt-16 leading-relaxed">
